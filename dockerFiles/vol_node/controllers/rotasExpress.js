...
module.exports = (app) => {
    ...
    //FUNÇÃO CHECA E PERMITE SE A ORIGEM SOLICITANTE É O SITE VIDADAFONTE.COM.BR E SE A SOLICITAÇÃO É GET   
    ...
    app.get("/buscalivroantigotesta", LiberaOrigemRegistraLog, (req, res) => {//fornece somente os livros (COMPONENTE selectTestamento)
        const dataAntigo = require("./antigoTestamento.json")
    ...
    app.get("/buscacapituloantigotesta:id", LiberaOrigemRegistraLog, (req, res) => {//fornece somente os capítulos dado o livro que vem no parametro ID
    ...
    app.get("/antigotesta/:livro/:capitulo", LiberaOrigemRegistraLog, (req, res) => { //LISTAR conform o livro e capitulo fornecidos
    ...
    app.get("/buscalivronovotesta", LiberaOrigemRegistraLog, (req, res) => { //fornece somente os livros (COMPONENTE selectTestamento)
    ...
    app.get("/buscacapitulonovotesta:id", LiberaOrigemRegistraLog, (req, res) => {//fornece somente os capítulos dado o livro que vem no parametro ID
    ...
    app.get("/novotesta/:livro/:capitulo", LiberaOrigemRegistraLog, (req, res) => { //LISTA conforme o livro e capitulo fornecidos
    ...
    app.get("/buscanumeroharpa", LiberaOrigemRegistraLog, (req, res) => {
    ...
    app.get("/buscatitulopornumero/:id", LiberaOrigemRegistraLog, (req, res) => { //retorna letra do hino conforme o numero solicitado
    ...
    app.get("/buscatituloporpalavra/:id", LiberaOrigemRegistraLog, (req, res) => {//busque o numero e hino dado a palavra fornecida
    ...
    app.get("/buscacuriosidade/:id", LiberaOrigemRegistraLog, (req, res) => {//busca curiosidades dado o nome do livro
    ...
    app.get("/biblianvi/pesquisa/:palavrapesquisabiblia", LiberaOrigemRegistraLog, (req, res) => {
    ...
    app.get("/biblianvi/pesquisa", LiberaOrigemRegistraLog, (req, res) => { //afim de trazer all books
