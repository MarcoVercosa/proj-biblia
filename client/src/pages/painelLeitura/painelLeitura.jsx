    ...
    return (
        <>
            ...
            <main className="painel-leitura-main">
                <div className="painel-leitura-main-container">
                        ...
                        <div className="painel-leitura-main-div-setas">
                            <div className="painel-leitura-main-div-setas-esquerda">
                                <Button
                                    ...
                                    onClick={async () => {
                                        setConteudo(await RetornaCapitulo(match.params.versao_id, match.params.testamento_id, match.params.livro_id, Number(conteudo?.capituloAtual)))
                                        SetVersiculo("na")
